...
/**
 * Checked exception for all errors that can occur during encryption or decryption. Typically this
 * is thrown for passing in unsuitable input values for secret keys, initialisation vectors, or data
 * to encrypt/decrypt.
 */
