...
import uk.gov.ons.census.casesvc.utility.pseudorandom.NumberTheory;
...
public class CaseRefGenerator {
  ...
  private static final BigInteger[] factors = NumberTheory.factor(modulus);
  ...
  public static int getCaseRef(int sequenceNumber, byte[] hmacKey) {
    ...
    BigInteger encryptedValue = fe1.encrypt(modulus, plaintextValue, hmacKey, iv, factors);
